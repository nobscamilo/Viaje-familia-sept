    ...
    <div className="mapa">
      ...
      <div className="mapa-hud-head">
        <div className="mapa-hud-info">
          <span className="mapa-hud-eyebrow">Cartografía del Viaje</span>
          <h2 className="mapa-hud-titulo">Mapa de Ruta & Trazado</h2>
          <span className="mapa-hud-sub">14 días de itinerario · Selección por día</span>
        </div>
        <div className="mapa-hud-stats">
          <div className="mapa-hud-stat-pill">
            <span className="mapa-hud-stat-k">Itinerario</span>
            <strong className="mapa-hud-stat-v">14 Días</strong>
          </div>
          <div className="mapa-hud-stat-pill">
            <span className="mapa-hud-stat-k">Grupo</span>
            <strong className="mapa-hud-stat-v">9 Viajeros</strong>
          </div>
        </div>
      </div>
